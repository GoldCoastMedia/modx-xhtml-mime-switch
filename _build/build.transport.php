<?php
/**
 * XHTML MIME Switch Build Script
 *
...
define('PKG_NAME','XHTML MIME Switch');
define('PKG_NAME_LOWER','xhtmlmimeswitch');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','beta1');
define('PKG_CATEGORY','XHTML MIME Switch');
...
$sources= array (
    ...
    'docs' => $root . 'core/components/xhtmlmimeswitch/docs/',
...
/* This section transfers every file in the local
 xhtmlmimeswitch/assets directory to the
 target site's assets/xhtmlmimeswitch directory on install.
...
/* This section transfers every file in the local 
 xhtmlmimeswitch/core directory to the
 target site's core/xhtmlmimeswitch directory on install.
